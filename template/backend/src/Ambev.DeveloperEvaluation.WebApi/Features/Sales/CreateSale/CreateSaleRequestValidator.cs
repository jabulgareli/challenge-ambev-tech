...
{
    internal class CreateSaleRequestValidator : AbstractValidator<CreateSaleRequest>
    {
    ...
    internal class SaleItemRequestValidator : AbstractValidator<SaleItemRequest>
    {
