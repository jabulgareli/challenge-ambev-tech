...
namespace Ambev.DeveloperEvaluation.Application.Sales.UpdateSale
{
    ...
    internal class UpdateSaleItemRequestValidator : AbstractValidator<UpdateSaleItemCommand>
    {
        internal UpdateSaleItemRequestValidator()
        {
